...
cp /Users/vasanth/repos/roboshop-shell/catalogue.service /etc/systemd/system/catalogue.service &>> $LOGFILE
...
cp /Users/vasanth/repos/roboshop-shell/mongo.repo /etc/yum.repos.d/mongo.repo
